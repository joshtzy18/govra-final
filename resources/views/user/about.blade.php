    ...
    <div class="flex flex-row gap-3 justify-center mx-20 w-auto h-auto p-10">
        ...
        <ul>
          ...
          <a href="/skills">
           ...
           <a href="about"><li class="h-10 flex gap-3 pl-3"><span><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
          </svg></span>About me</li></a> 


           <a href="/resume"><li class="h-10 flex gap-3 pl-3"> <span><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="flex flex-col h-auto w-[70%] border-2  border-solid bg-white border-sky-50 drop-shadow-sm py-2 px-5 resume-container">
          ...
          <div class="w-full flex flex-row gap-2 pt-5 uploaded-resume">
            <span><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
            </svg></span><span class="text-lg font-sans">About me</span>
            <button><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-6">
              <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
            </svg>
            </button>
          </div>

         <div class=" flex flex-row w-full h-auto mt-10 pl-5 ">
          <span class="text-gray-500 font-sans" >Name  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>
          <span class=" font-sans">Alfrancis Crasco</span>
         </div>

         <div class=" flex flex-row w-full h-auto mt-5 pl-5 ">
          <span class="text-gray-500 font-sans" >Contact No.  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  </span>
          <span class=" font-sans">(+63) 9366453047</span>
         </div>

         <div class=" flex flex-row w-full h-auto mt-5 pl-5 ">
          <span class="text-gray-500 font-sans" >Email  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>
          <span class=" font-sans">onlymapex2@gmail.com</span>
         </div>

         <div class=" flex flex-row w-full h-auto mt-5 pl-5 ">
          <span class="text-gray-500 font-sans" >Address  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>
          <span class=" font-sans">Blk 1A Lot 33, Sunshine Homes, Brgy.Magliman, 2000, San Fernando, Central Luzon, Philippines</span>
         </div>

         <div class=" flex flex-row w-full h-auto mt-5 pl-5 ">
          <span class="text-gray-500 font-sans" >Date of birth  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  </span>
          <span class=" font-sans">23 February 2002</span>
         </div>

         <div class=" flex flex-row w-full h-auto mt-5 pl-5 ">
          <span class="text-gray-500 font-sans" >Nationality  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  </span>
          <span class=" font-sans">Philippines</span>
         </div>
