    ...
    <div class="flex flex-row gap-3 justify-center mx-20 w-auto h-auto p-10">
        ...
        <div class="flex flex-col h-auto w-[70%] border-2  border-solid bg-white border-sky-50 drop-shadow-sm py-2 px-5 resume-container">
          ...
          <div class="w-full flex flex-row gap-2 pt-5 uploaded-resume">
            <span><svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0 1 1 0 00-1.414 1.414 4 4 0 005.656 0l3-3a4 4 0 00-5.656-5.656l-1.5 1.5a1 1 0 101.414 1.414l1.5-1.5zm-5 5a2 2 0 012.828 0 1 1 0 101.414-1.414 4 4 0 00-5.656 0l-3 3a4 4 0 105.656 5.656l1.5-1.5a1 1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z" clip-rule="evenodd" />
            </svg></span><span class="text-lg font-sans">Uploaded Resume</span>
          </div>

          
       
          <div class=" mt-12  pl-12 border-2 border-solid border-red-600">

              <div class="flex flex-row gap-3">
                <span class="text-gray-500">File name</span>
                <span class="">cv_Alfrancis Crasco.docx</span>
              ...
              <div class="flex flex-row gap-3 mt-3">
                ...
                <span class="">14 Sep 2023 4:27PM</span>
