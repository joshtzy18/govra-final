<x-app-layout>
    ...
    <div class="flex flex-row gap-3 justify-center mx-20 w-auto h-auto p-10">
        ...
        <ul>
           ...
           <a href="/myjobprofile"><li class="w-full h-auto  flex items-center justify-center flex-row gap-5 pr-2 py-2 ml-3 border-2 border-solid border-red-500 mb-2">
           ...
           <a href="work-experience">
            ...
            <a href="/education"><li class="h-10 flex gap-3 pl-3 "><span><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5  text-gray-700 " viewBox="0 0 20 20" fill="currentColor">
  ...
  <div class=" text-start flex flex-row w-full items-center my-4"">
    <span><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5  text-gray-700" viewBox="0 0 20 20" fill="currentColor">
      <path fill-rule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd" />
      <path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z" />
    </svg></span>  &nbsp; <span class="text-lg"> Level experience</span>
  </div>
  

  <div class="flex flex-row gap-36">
    <span class="text-sm text-gray-500 font-sans">IT Clerk</span>

    <div class="flex mb-3">
      <span class="font-sans text-sm">
        Student seeking internship or part-time jobs</span>
    </div>

    <div class="flex"><button ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-6">
  ...
  <hr class="w-full mt-10 flex flex-row">
